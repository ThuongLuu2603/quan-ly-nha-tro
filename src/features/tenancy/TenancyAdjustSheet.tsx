...
import { Field, MoneyInput, Sheet, TextInput } from '../../ui/components'
...
export function TenancyAdjustSheet({
  ...
  const canSave = rent > 0 && deposit >= 0 && (rentChanged || depositChanged || note.trim() !== (tenancy.note ?? ''))
  ...
  const preview = useMemo(() => {
    ...
    return parts
  }, [rentChanged, depositIncrease, issueDepositInvoice, deposit, tenancy.deposit, tenancy.rentPaidThrough])
